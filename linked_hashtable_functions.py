...
def hashSearchLinked(linked_hashtable):

    #getting input
    input_number = inputNumber()

    #search for given phone number
    phone_number_data = linked_hashtable.search(int(input_number[1:]))
...
def hashDeleteLinked(linked_hashtable):

    #getting input
    input_number = int(inputNumber()[1:])

    if not linked_hashtable.search(input_number):
        print("\n================ SORRY :( ================")
        print("The number does not exist in our database!")
        print("==========================================\n")

    linked_hashtable.delete(input_number)
    print("\n================= SUCCESS :) ====================")
    print("Given number's data has been deleted Successfully!")
    print("=================================================\n")


def hashInsertLinked(linked_hashtable):
    ...
    linked_hashtable.insert(data)

    print("\n================= SUCCESS :) ====================")
    print("Given number's data has been added Successfully!")
    print("=================================================\n")
